...
export default function PlaylistCreator({session}: PromptCreatorProps) {
    ...
    return (
        <div>
            {session && (
                <Box display={"flex"} flexDirection={"column"} height={"70vh"} width={"90vw"} maxHeight={700} maxWidth={1000}>
                    <PromptCreator step={setStep} userPrompt={setUserPrompt}></PromptCreator>
                    {step === 5 &&
